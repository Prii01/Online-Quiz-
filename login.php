  ...
  <body background="assets/src/images/background.jpg">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a href="http://localhost/quizproject/check_result.php" class="nav-link">Check Results</a>
            </li>
            <li class="nav-item">
                <a href="http://localhost/quizproject/upload_subject.php" class="nav-link">Add Question</a>
            </li>
            <li class="nav-item">
                <a href="http://localhost/quizproject/delete_subject.php" class="nav-link">Delete Question</a>
            </li>                  
        </ul>
        ...
        <span class="navbar-text">
            <a href="logout.php" class="nav-link">Logged out</a>
        </span>        
    </div>
    </nav>
